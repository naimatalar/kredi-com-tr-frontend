...
export const priceShow = (amount) => {
    const randomTys = Math.floor((Math.random() * 3) + 1)
    ...
    const data = {
            ...
            <div className="row justify-content-center mt-5  cl-content-font">
                <div className="col-12 row mt-2 justify-content-center ">
                    <div className="col-12 text-center">
                        <h2>{PriceSplitter(amount)} ₺ Gelire İle İhtiyaç Kredisi.</h2>

                    </div>
                    <div className="col-12">
                        <h3 className="text-center">{PriceSplitter(amount)} ₺ Aylık Kazanç İle Kredi Hesaplaması Nasıl Yapılır? </h3>
                    </div>
                </div>
                <div className="col-12">
        ...
        "4000": (<div className="row justify-content-center mt-5  cl-content-font">
            <div className="col-12 row mt-2 justify-content-center ">
                <div className="col-12 text-center">
                    <h2>{PriceSplitter(amount)} ₺ Gelir / Maaş  Göre Kredi Hesaplama.</h2>

                </div>
                <div className="col-12">
                    <h3 className="text-center">Ortalama {PriceSplitter(amount)} ₺ Gelir/Maaş Kredi Hesaplama Nasıl Yapılıyor? </h3>
                </div>
            </div>
            <div className="col-12">
                <p> &nbsp;  &nbsp;   &nbsp;  &nbsp;   &nbsp;  &nbsp;   &nbsp;  &nbsp;  Gelirinizi {PriceSplitter(amount)} ₺ olarak belirtilmiştir
                    seçtiğiniz gelir tutarlı bir kredi hesaplaması yapılabilmesi için ortalama aylık giderinize seçin.
        ...
        "6000": (<div className="row justify-content-center mt-5  cl-content-font">
            <div className="col-12 row mt-2 justify-content-center ">
                ...
                <div className="col-12">
                    <h3 className="text-center">{PriceSplitter(amount)} ₺ Maaş İle Hesaplama Nasıl Yapılır ? </h3>
                </div>
            </div>
            <div className="col-12">
        ...
        "8000": (<div className="row justify-content-center mt-5  cl-content-font">
            <div className="col-12 row mt-2 justify-content-center ">
                <div className="col-12 text-center">
                    <h2>{PriceSplitter(amount)} ₺ Gelire İle İhtiyaç Kredi Hesaplama.</h2>

                </div>
                <div className="col-12">
                    <h3 className="text-center">Ortalama {PriceSplitter(amount)} ₺ Aylık Gelire Göre Kredi Hesaplama Nasıl Yapılır? </h3>
                </div>
            </div>
            <div className="col-12">
                <p> &nbsp;  &nbsp;   &nbsp;  &nbsp;   &nbsp;  &nbsp;   &nbsp;  &nbsp;  Gelirinizi {PriceSplitter(amount)} ₺ olarak belirtilmiş olup
