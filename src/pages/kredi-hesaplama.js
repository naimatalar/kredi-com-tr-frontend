...
function KediHesaplama(props) {
    return (
        <>
            ...
            <Seo title={"Kredi Hesaplama"} description={"Faiz oranına göre kredi hesaplama ve ödeyebileceğiniz en uygun krediyi sizin için bulmanın en kolay yolu. Bütün bankaların kredi faiz oranlarını karşılaştır ve başvur. "} />
