    ...
    return (<>
        ...
        <div className="col-12 mb-4">
            ...
            <div className="col-12 mt-3 mb-3 text-center">
                <h1 className="home-title" style={{ marginTop: 0 }}>İhtiyaç Kredini <span style={{ fontWeight: "bold" }}> Ara</span>, Oranları <span style={{ fontWeight: "bold" }}>Listele</span> , Anında <span style={{ fontWeight: "bold" }}> Başvur!</span>  </h1>
            </div>
